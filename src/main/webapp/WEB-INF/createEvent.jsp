    ...
    <form:form action="/create" method="post" modelAttribute="event" class="bg-white p-6 rounded-xl shadow space-y-6">
        ...
        <a href="/ai/"
           class="px-4 text-center rounded-full bg-orange-300 py-3 text-base font-semibold text-white hover:bg-secondary-orange">
            <fmt:message key="page.createEvent.aiButton"/>
        </a>
        ...
        <div class="mb-6">
            <label class="block text-orange-700 font-medium mb-2">
        ...
        <div class="mt-9">
            <label class="block text-sm font-medium text-gray-700 mb-2">
                <fmt:message key="form.event.tasks.label"/>
            </label>
            <input type="text" name="taskDescriptions"
                   placeholder="<fmt:message key='form.event.tasks.placeholder1'/>"
            ...
            <input type="text" name="taskDescriptions"
                   placeholder="<fmt:message key='form.event.tasks.placeholder2'/>"
            ...
            <input type="text" name="taskDescriptions"
                   placeholder="<fmt:message key='form.event.tasks.placeholder3'/>"
                   class="w-full mt-5 border border-orange-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-purple focus:border-primary-purple"/>
        </div>
        ...
        <div class="mt-9">
            <label class="block text-sm font-medium text-gray-700 mb-2">
                <fmt:message key="form.event.outcomes.label"/>
            </label>
            <input type="text"  name="outcomesNames"
                   placeholder="<fmt:message key='form.event.outcomes.placeholder1'/>"
                   class="w-full border border-orange-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-purple focus:border-primary-purple"/>
            <input type="text" name="outcomesNames"
                   placeholder="<fmt:message key='form.event.outcomes.placeholder2'/>"
                   class="w-full mt-5 border border-orange-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-purple focus:border-primary-purple"/>
            <input type="text" name="outcomesNames"
                   placeholder="<fmt:message key='form.event.outcomes.placeholder3'/>"
                   class="w-full mt-5 border border-orange-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-purple focus:border-primary-purple"/>
        </div>
