...
<body class="bg-gradient-to-br from-primary-purple/10 to-secondary-orange/10 min-h-screen">
            ...
            <form:form method="POST" action="/loin" modelAttribute="loginForm">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="${pageContext.request.contextPath}/forgot-password"
                       class="text-primary-purple hover:text-secondary-orange font-medium">
                        Forgot password?
                    </a>
                </div>
...
<p class="text-center text-gray-600">
    ...
    <a href="${pageContext.request.contextPath}/signup" class="text-primary-purple hover:text-secondary-orange font-semibold">Sign up</a>
</p>
